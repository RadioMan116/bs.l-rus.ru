...
/*# AVOID COLLISIONS #*/
// Последовательность порядка обязательно должна быть такой

// lazysize-config.js
window.lazySizesConfig=window.lazySizesConfig||{},window.lazySizesConfig.init=!1,lazySizesConfig.expand=1e3;
// lazysize-custom.js
var checkSupportWebp=function(t){var e=new Image;e.onload=e.onerror=function(){isSupported=2===e.height,t(isSupported)},e.src="data:image/webp;base64,UklGRjoAAABXRUJQVlA4IC4AAACyAgCdASoCAAIALmk0mk0iIiIiIgBoSygABc6WWgAA/veff/0PP8bA//LwYAAA"};checkSupportWebp(function(t){var e;t?document.addEventListener("lazybeforeunveil",function(t){var e=t.target.getAttribute("data-bg-custom"),a=t.target.getAttribute("data-webp");a?t.target.style.backgroundImage="url("+a+")":e&&(t.target.style.backgroundImage="url("+e+")")}):document.addEventListener("lazybeforeunveil",function(t){var e=t.target.getAttribute("data-bg-custom");e&&(t.target.style.backgroundImage="url("+e+")")},!1),e=setTimeout(function(){window.lazySizes&&(clearTimeout(e),window.lazySizes.init())})});
// ls.bgset.min.js
